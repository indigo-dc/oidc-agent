...
inline static char* issuer_getDeviceAuthorizationEndpoint(struct oidc_issuer iss) { return iss.device_authorization_endpoint; };
...
inline static void issuer_setDeviceAuthorizationEndpoint(struct oidc_issuer* iss, char* device_authorization_endpoint) { clearFreeString(iss->device_authorization_endpoint); iss->device_authorization_endpoint=device_authorization_endpoint; }
