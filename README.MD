...
[![Build Status](https://jenkins.indigo-datacloud.eu:8080/buildStatus/icon?job=Pipeline-as-code/oidc-agent/master)](https://jenkins.indigo-datacloud.eu:8080/job/Pipeline-as-code/oidc-agent/job/master/)
...
### From Source
Refer to the [documentation](https://indigo-dc.gitbooks.io/oidc-agent/admin.html)
